...
void A1CollisionDetecter::UpdateState(raisim::VecDyn generalizedPosition, raisim::VecDyn generalizedVelocity, Eigen::Vector2d torque)
{
    mGeneralizedPosition[0] = generalizedPosition[0];
    mGeneralizedPosition[1] = generalizedPosition[1];
    mGeneralizedVelocity[0] = generalizedVelocity[0];
    mGeneralizedVelocity[1] = generalizedVelocity[1];
    mTempTorque[0] = torque[0];
    mTempTorque[1] = torque[1];
    if (mbFirstRun == true)
    {
        mMomentumPrev[0] = 0;
        mMomentumPrev[1] = 0;
