...
#include "ui_wheeledRobotSimulationWindow.h"
#include <iostream>
...
MainWindow::MainWindow(QWidget *parent) :
    ...
    ui->widget_1->graph(0)->setName("position");
    ui->widget_1->graph(0)->setPen(QPen(QColor(0, 0, 255)));
    ui->widget_1->addGraph();
    ui->widget_1->graph(1)->setName("desired position");
...
void MainWindow::on_pushButton_clicked() {
    std::cout << "'Front' button is clicked" << std::endl;
    if (button1) { button1 = false; }
    else { button1 = true; }
}

void MainWindow::on_pushButton_2_clicked() {
    std::cout << "'Left' button is clicked" << std::endl;
